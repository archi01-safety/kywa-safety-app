...
with col1:
    ...
    dept_list = ["활동부(국립청소년시설)", "협력부(국립청소년시설)", "근로자대표", "청소년성장지원부", "지도인력양성부", "지도인력개발부", "청렴감사실", "기획혁신부", "인재경영부", "홍보전략부", "안전경영부", "재무회계부", "디지털정보부", "활동기획부", "미래활동부", "정책사업부", "활동안전부", "활동인증부", "자회사", "협력업체(공사, 용역 등)"]
